...
# Memory: vctcxo_tamer_0
MEM_1 := nios_system_vctcxo_tamer_0
$(MEM_1)_NAME := vctcxo_tamer_0
...
$(MEM_1)_START := 0x00009300
$(MEM_1)_END := 0x000093ff
$(MEM_1)_SPAN := 0x00000100
$(MEM_1)_HIERARCHICAL_PATH := vctcxo_tamer_0
$(MEM_1)_WIDTH := 8
$(MEM_1)_HEX_DATA_WIDTH := 8
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: vctcxo_tamer_0
vctcxo_tamer_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
ELF_TO_HEX_CMD_NO_BOOTLOADER = $(ELF2HEX) $< $(mem_start_address) $(mem_end_address) --width=$(mem_hex_width) --record=$(shell expr ${mem_hex_width} / 8) --record=$(shell expr ${mem_hex_width} / 8) --record=$(shell expr ${mem_hex_width} / 8) --record=$(shell expr ${mem_hex_width} / 8) \
