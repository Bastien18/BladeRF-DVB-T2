...
entity DVBT2_mod_top is
	port (
		...
		clock_x2         : in  std_logic                     := '0';             -- cms0041_clock_x2.clk
		reg_irq          : out std_logic;                                        --              irq.irq
		reset_n          : in  std_logic                     := '0'              --          reset_n.reset_n
	);
end entity DVBT2_mod_top;

architecture rtl of DVBT2_mod_top is
...
begin
	...
	dvbt2mod_0 : component cms0041_wrap
		generic map (
			...
			BUILD_CRITICAL_FILTER        => 2,
			BUILD_INBAND_EQUALISER       => 1,
			BUILD_FFT_WINDOW             => 1,
			BUILD_FEF_SUPPORT            => 0,
		...
		port map (
			...
			clock_x2         => clock_x2,         -- cms0041_clock_x2.clk
...
end architecture rtl; -- of DVBT2_mod_top
